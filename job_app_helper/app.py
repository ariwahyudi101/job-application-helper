...
class JobApplicationPipeline:
    ...
    def run_application(self, url: str) -> int:
        ...
        resume_path = self.resume_rewrite.rewrite(self.settings.paths.default_resume_path, parsed_job, gap)
        cover_letter_path = self.cover_letter.write(resume_path, parsed_job, research)
